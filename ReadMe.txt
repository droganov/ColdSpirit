...
2. Copy "spirit" folder to the webroot or map it as /spirit in railo admin. If you yes spirit for production, make sure /spirit/admin is accessible from the web.
